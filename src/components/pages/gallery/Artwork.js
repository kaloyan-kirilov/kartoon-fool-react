...
export const art = artArray.reverse();

export const set = {
    page_0: null, 
    page_1: [0, 1, 2, 3, 4, 5, 6, 7, 8],
    page_2: [0, 9, 10, 11, 12, 13, 14, 15, 16],
    page_3: [0, 17, 18, 19, 20, 21, 22, 23, 24],
    page_4: [0, 25, 26, 27, 28, 29, 30, 31, 32],
    page_5: [0, 33, 34, 35, 36, 37, 38, 39, 40],
    page_6: [0, 41, 42, 43, 0, 0, 0, 0, 0]
}